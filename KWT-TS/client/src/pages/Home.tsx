		...
		<>
			<div className="sliderNote">
				<div className="hideText">
					<p className="hiddenText">OGÓLNOPOLSKA</p>
				</div>
				<div className="hideText">
					<p className="hiddenText">OLIMPIADA</p>
				</div>
				<div className="hideText">
					<p className="hiddenText">WIEDZY</p>
				</div>
				<div className="hideText">
					<p className="hiddenText">ELEKTRYCZNEJ</p>
				</div>
				<div className="hideText">
					<p className="hiddenText">I</p>
				</div>
				<div className="hideText">
					<p className="hiddenText">ELEKTRONICZNEJ</p>
				</div>
			</div>
